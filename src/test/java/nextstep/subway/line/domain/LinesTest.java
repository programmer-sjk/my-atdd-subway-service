...
class LinesTest {
    ...
    void stations() {
        ...
        Line 신분당선 = LineTestFactory.create("신분당선", "bg-red-600", 판교역, 강남역, 10, 1_000);
        Line 일호선 = LineTestFactory.create("신분당선", "bg-red-600", 인천역, 부평역, 10, 1_000);
    ...
    void sections() {
        ...
        Line 신분당선 = new Line("신분당선", "bg-red-600", new ExtraCharge(1_000));
