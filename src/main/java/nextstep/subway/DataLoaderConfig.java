...
public class DataLoaderConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Line 신분당선 = new Line("신분당선", "red lighten-1", new Fare(2_000));
        신분당선.addSection(new Section(강남역, 양재역, new Distance(10)));

        Line 이호선 = new Line("2호선", "green lighten-1", new Fare(1_000));
        이호선.addSection(new Section(교대역, 강남역, new Distance(10)));

        Line 삼호선 = new Line("3호선", "orange darken-1", new Fare(900));
